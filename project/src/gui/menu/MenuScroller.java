 ...
 * bottom of the menu.
 * <P>
 * <B>Implementation note:</B> The default number of items to display at a time is 15, and the
 ...
 * @licence Darryl "Like all code published on the blog, MenuScroller is free to use, at your own risk . A link to the blog page in the doc comments or elsewhere would be nice, but is by no means mandatory."
 */
public class MenuScroller
{
	 ...
	 * @uml.property name="topFixedCount"
	 */
	 ...
	 * 
	 * @return the number of items
	 * @uml.property name="bottomFixedCount"
	 */
