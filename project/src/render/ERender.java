...
/**
 * Upravena povodna trieda ERender, trieda je tu skopirovana pretoze jej design
 * sa neda vyuzit spolu s mojim. Preto som to sem skopiroval a upravil potrebne riadky.
 * 
 * @author JUNG Project
...
public class ERender<V, E>
{
	...
	public void paintEdge(RenderContext<V, E> rc, Layout<V, E> layout, E e,
		...
		drawSimpleEdge(rc, layout, e, v1, v2);
	...
	/**
	 * Draws the edge <code>e</code>, whose endpoints are at <code>(x1,y1)</code> and
	 * <code>(x2,y2)</code>, on the graphics context <code>g</code>.
	...
	protected void drawSimpleEdge(RenderContext<V, E> rc, Layout<V, E> layout,
		...
		if (isLoop) {
			...
			if (rc.getEdgeShapeTransformer() instanceof IndexedRendering) {
				EdgeIndexFunction<V, E> peif = ((IndexedRendering<V, E>) rc.getEdgeShapeTransformer()).getEdgeIndexFunction();
	...
	private Component prepareRenderer(RenderContext<V, E> rc,
	...
	public void renderLabel(RenderContext<V, E> rc, Layout<V, E> layout, E e,
			V v1, V v2, String label) {
